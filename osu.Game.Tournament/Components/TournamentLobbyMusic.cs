...
namespace osu.Game.Tournament.Components
{
    ...
    public partial class TournamentLobbyMusic : Component
    {
        ...
        /// </remarks>
        public static PlaybackAction Decide(bool isConnected, TourneyState state, bool hasResolvedBeatmap)
        {
        ...
        {
            var action = Decide(ipc.IsConnected.Value, ipc.State.Value, hasResolvedBeatmap);
