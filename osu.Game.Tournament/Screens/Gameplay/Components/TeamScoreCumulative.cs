    ...
    public partial class TeamScoreCumulative : CommaSeparatedScoreCounter
    {
        ...
        protected override void LoadComplete()
        {
            ...
            ladder.CurrentMatch.BindValueChanged(vce =>
            {
                ...
                var targetBindable = teamColour == TeamColour.Red ? vce.NewValue.Team1Score : vce.NewValue.Team2Score;
                currentTeamScore.BindTo(targetBindable);
            }, true);

            currentTeamScore.BindValueChanged(vce => Current.Value = vce.NewValue ?? 0, true);
        }
