...
{
    public partial class TestSceneDrawableTournament1V1Team : OsuGridTestScene
    {
        [Cached]
        protected LadderInfo Ladder { get; private set; } = new LadderInfo();

        public TestSceneDrawableTournament1V1Team()
            : base(4, 3)
        {
            ...
            var team = new TournamentTeam
            {
                ...
                Players =
                {
                    new TournamentUser { Username = "ASecretBox", CountryCode = CountryCode.AU },
                },
            };
