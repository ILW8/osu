        ...
        public void Test1V1()
        {
            ...
            AddStep("setup test", () =>
            {
                ...
                match1 = new TournamentMatch(
                    new TournamentTeam
                    {
                        FlagName = { Value = "bunnylikemoney" },
                        FullName = { Value = "bunnylikemoney" },
                        Acronym = { Value = "bunnylikemoney" },
                        Players = { new TournamentUser { CountryCode = CountryCode.US } }
                    },
                    new TournamentTeam
                    {
                        FlagName = { Value = "xootynator" },
                        FullName = { Value = "xootynator" },
                        Acronym = { Value = "xootynator" },
                        Players = { new TournamentUser { CountryCode = CountryCode.CA } }
                    })
                {
                    Team1Score = { Value = 4 },
                    Team2Score = { Value = 1 },
                ...
                match2 = new TournamentMatch(
                    new TournamentTeam
                    {
                        FlagName = { Value = "ConsumerOfBean" },
                        FullName = { Value = "ConsumerOfBean" },
                        Acronym = { Value = "ConsumerOfBean" },
                        Players = { new TournamentUser { CountryCode = CountryCode.US } }
                    }
                );
