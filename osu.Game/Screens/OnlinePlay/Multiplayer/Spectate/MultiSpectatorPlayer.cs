...
namespace osu.Game.Screens.OnlinePlay.Multiplayer.Spectate
{
    ...
    public partial class MultiSpectatorPlayer : SpectatorPlayer
    {
        ...
        /// <param name="showFailingLayer">Whether the low-health red overlay should be shown for this player.</param>
        public MultiSpectatorPlayer(Score score, SpectatorPlayerClock spectatorPlayerClock, bool showFailingLayer = true)
            : base(score, new PlayerConfiguration { AllowUserInteraction = false, ShowFailingLayer = showFailingLayer })
        {
